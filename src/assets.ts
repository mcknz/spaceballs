...
export namespace Images {
    ...
    export class ImagesSpaceship {
        static getName(): string { return 'Spaceship'; };

        static getPNG(): string { return require('assets/images/Spaceship.png'); };
    }
}

export namespace Spritesheets {
    export class SpritesheetsProjectileSprites {
        static getName(): string { return 'projectileSprites'; };

        static getPNG(): string { return require('assets/spritesheets/projectileSprites.[31,31].png'); };
        static getFrameWidth(): number { return 31; };
